    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(upload_to='uploads/accommodation_images/')),
                ('uploaded_at', models.DateTimeField(auto_now_add=True)),
                ('accommodation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='accommodation_images', to='property_management.accommodation')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='location',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='property_management.location'),
        ),
    ]
